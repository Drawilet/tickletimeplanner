        ...
        <div class="bg-base rounded-lg w-1/2 shadow-xl pb-8">
            <div class="w-full h-[250px]">
                <div class="mx-auto w-full h-[250px] bg-base-300 rounded-md overflow-hidden relative">
                    @if($image_background)
                    <img src="{{ $image_background->temporaryUrl() }}" class="mx-auto overflow-hidden rounded-md w-1/2">
                    @else
            ...
            <div class="flex flex-col items-center -mt-20">
                <div class="mx-auto h-32 w-32 bg-base-300 rounded-full overflow-hidden relative">
                    @if ($image_profile)
                        <img src="{{ $image_profile->temporaryUrl() }}" alt="" class="mx-auto overflow-hidden rounded-full max-h-32">
                    @else
