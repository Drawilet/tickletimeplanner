<div class="overflow-x-auto">
    ...
    <div class="max-w-7xl mx-auto sm:px6 lg:px-8">
        <div class="bg-base-100 dark:bg-gray-950 overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
    ...
    <div class="mockup-browser border border-base-300">
        <div class="mockup-browser-toolbar flex items-center">
            ...
            <button wire:click="OpenModal"class=" btn btn-ghost bg-base-100 hover:bg-base-300 text-black hover:text-blue-50 py-2 px-4 ml-2">
                    ...
                    <tr>
                        <td>
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <img class="text-sm opacity-50">/></div>
                                </div>
                            </div>
                        </td>
                        <td>
                        ...
                        <th>
                                <button class="btn btn-ghost  hover:text-blue-50 "wire:click="edit({{$Customers->id}})">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.1" stroke="currentColor" class="w-6 h-6">
                                ...
                                <button  class="btn btn-ghost  hover:text-blue-50" wire:click="delete({{ $Customers->id }})">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.1" stroke="currentColor" class="w-6 h-6 center">
