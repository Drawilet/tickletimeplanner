<x-form-section submit="updatePassword">
    <x-slot name="title">
        {{ __('profile-lang.Update Password') }}
    </x-slot>

    <x-slot name="description">
        {{ __('profile-lang.Ensure your account is using a long, random password to stay secure.') }}
    </x-slot>

    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <x-label for="current_password" value="{{ __('profile-lang.Current Password') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password" value="{{ __('profile-lang.New Password') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password_confirmation" value="{{ __('profile-lang.Confirm Password') }}" />
