...
return [
    ...
    "pre-space" => [
        "text-1" => "Let's get ready to set up your first space!",
        "text-2" => "Before we start, let me explain what spaces are and why they're important:",
        "text-3" => "Spaces in",
        ...
        "text-5" => "Each space can have its own characteristics, such as capacity, available resources, and specific schedules. This makes managing events in different places easier and provides flexibility to adapt to the needs of your activities.",
        "text-6" => "Ready to set up your first space? Let's go!"
    ],
    "product-setup" => [
        ...
        "text-3" => "To get started, simply click the 'Create Space' button below."
    ],
    "space-setup" => [
        "text-1" => "Space Setup",
